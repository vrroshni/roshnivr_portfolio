...
import AppParticles from '../elements/AppParticles';
        ...
        <div className='flex flex-col md:flex-row items-center justify-between w-full'>
          ...
          <div className="w-full mt-0 md:mt-4 md:w-1/2 flex flex-col items-center md:items-start self-center md:self-start px-4 md:px-0">
            ...
            <div className='flex items-center justify-center md:items-start mt-2'>
              ...
              <a className="bg-white mt-2 md:mt-0 ml-0 sm:ml-3 p-3 text-black flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border-black " href="https://linkedin.com" target="_blank">
                <MdAttachEmail />
              </a>
